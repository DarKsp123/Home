...
table_cost = table_quantity * table_price + table_quantity_1 * table_price_1
print('Стол -', table_quantity + table_quantity_1, 'шт., стоимость', table_cost, 'руб.')

sofa_quantity = store[goods['Диван']][0]['quantity']
sofa_quantity_1 = store[goods['Диван']][1]['quantity']
sofa_price = store[goods['Диван']][0]['price']
sofa_price_1 = store[goods['Диван']][1]['price']
sofa_cost = sofa_quantity * sofa_price + sofa_quantity_1 * sofa_price_1
print('Диван -', sofa_quantity + sofa_quantity_1, 'шт., стоимость', sofa_cost, 'руб.')
...
chair_cost = chair_quantity * chair_price + chair_quantity_1 * chair_price_1 + chair_quantity_2 * chair_price_2
print('Стул -', chair_quantity + chair_quantity_1 + chair_quantity_2, 'шт., стоимость', chair_cost, 'руб.')
